        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-white/60 text-lg max-w-2xl mx-auto">
              Simulate and calculate issue priorities using our AI-driven
              scoring algorithm.
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-white/70 mb-2">
                    Severity (1-10):{" "}
                    <span className="text-violet-400">{formData.severity}</span>
                  </label>
                  <input
                    type="range"
                    min="1"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {[
                      ...
                      <label
                        key={key}
                        className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/5 cursor-pointer hover:bg-white/10 transition"
                      >
                        <input
                          type="checkbox"
                          checked={
            ...
            >
              {result ? (
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 md:p-8 h-full">
                  ...
                  <div className="flex items-center justify-between mb-8 p-4 bg-white/5 rounded-2xl border border-white/5">
                    <div>
                      ...
                      <p
                        className={`text-2xl font-bold uppercase tracking-wider ${getPriorityColor(result.priority)}`}
                      >
                        {result.priority}
                      </p>
                    </div>
                        ...
                        <div key={key} className="bg-black/20 p-3 rounded-xl">
                          ...
                          <div className="w-full bg-white/5 rounded-full h-1.5">
                            <div
                              ...
                              style={{
                                width: `${Math.min(((value as number) / 20) * 100, 100)}%`,
                              }}
                            />
                          </div>
                        </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 md:p-8 h-full flex flex-col items-center justify-center text-center text-white/40">
                  ...
                  <p>
                    Adjust parameters and click calculate to see the priority
                    analysis.
                  </p>
                </div>
              )}

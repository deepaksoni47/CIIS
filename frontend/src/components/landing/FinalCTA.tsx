        ...
        >
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="relative inline-flex items-center gap-3 px-12 py-6 rounded-full bg-gradient-to-r from-violet-600 via-fuchsia-600 to-violet-600 bg-size-200 hover:bg-pos-100 text-white text-xl font-bold shadow-2xl shadow-fuchsia-500/30 transition-all duration-300 group"
            >
